...
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_AShults')
	 Begin 
	  Alter Database [Assignment07DB_AShults] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_AShults;
	 End
	Create Database Assignment07DB_AShults;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_AShults;
...
FROM vProductInventories 
	GROUP BY ProductName, InventoryCount, InventoryDate
...
FROM vProductInventoriesWithPreviousMonthCounts
	GROUP BY ProductName, InventoryCount, InventoryDate, PreviousMonthCount
		ORDER BY ProductName, Month(InventoryDate)
go
